...
// See findAssignmentElementsByBoardIds/findAssignmentSubmissionsByParentIds - escapes every
// character with special meaning in a regex so a value embedded into a $re query can never be
// read as anything but a literal string.

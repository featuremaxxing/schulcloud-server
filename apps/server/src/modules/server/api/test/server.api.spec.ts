	...
	describe('[GET] /config/public', () => {
		it('should be return configuration as json with all required keys', async () => {
			...
			const expectedResultKeys: (keyof ConfigResponse)[] = [
				...
				'FEATURE_COLUMN_BOARD_POLL_ENABLED',
				'FEATURE_COLUMN_BOARD_CHECKBOX_ENABLED',
				'FEATURE_BOARD_PROGRESS_ENABLED',
				'FEATURE_AI_ENABLED',
				'FEATURE_COLUMN_BOARD_ASSIGNMENT_ENABLED',
				'FEATURE_PERSONAL_LEARNING_ROOM_ENABLED',
